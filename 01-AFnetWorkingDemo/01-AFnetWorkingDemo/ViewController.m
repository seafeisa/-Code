...
-(void)viewDidLoad{
  _arr=@[@"AFHTTPRequestOperationViewController",@"AFHttpOperationMagViewController",@"AFURLsessionMagViewController",@"HttpSeesionMagViewController",@"ReachablityViewController"];
